    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-white">Clarioed</h3>
            <p className="text-gray-400">
              Instant solutions to your academic doubts. Connect with expert tutors and excel in your studies.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Clarioed. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
